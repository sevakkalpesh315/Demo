...
public class Add_Update_User extends Activity {
    ...
    int USER_ID;
    chintan.khetiya.sqlite.cursor.DatabaseHandler dbHandler = new chintan.khetiya.sqlite.cursor.DatabaseHandler(this);
	...
	if (called_from.equalsIgnoreCase("add")) {
	    ...
	    chintan.khetiya.sqlite.cursor.Contact c = dbHandler.Get_Contact(USER_ID);
	...
	add_save_btn.setOnClickListener(new View.OnClickListener() {
		...
		/*if (valid_name != null && valid_mob_number != null
		    ...
		    dbHandler.Add_Contact(new chintan.khetiya.sqlite.cursor.Contact(valid_name,
	...
	update_btn.setOnClickListener(new View.OnClickListener() {
		...
		if (valid_name != null && valid_mob_number != null
		    ...
		    dbHandler.Update_Contact(new chintan.khetiya.sqlite.cursor.Contact(USER_ID, valid_name,
			    valid_mob_number, valid_email));
		    dbHandler.close();
